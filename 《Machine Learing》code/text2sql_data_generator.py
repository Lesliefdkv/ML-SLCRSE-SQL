...
def parse_option():
    ...
    parser.add_argument('--topk_table_num', type = int, default = 5,
                        help = '在排序后的数据集中，只保留topk_table_num个表')
    parser.add_argument('--topk_column_num', type = int, default = 6,
                        help = '在排序后的数据集中，只保留topk_column_num个列')
    parser.add_argument('--mode', type = str, default = "eval",
                        help = '数据集的类型: train, eval, test.')
